...
insert into customer values(null, '鷲沼　美智子','大阪府大阪市中央区大手前2','saginuma','EgretPond3');
insert into customer values(null, '鷲尾　史郎','愛知県名古屋市中区三の丸3-1-2','washio','EagleTail4');
insert into customer values(null, '牛島　大吾','埼玉県さいたま市浦和区高砂3-15-1','ushijima','CowIsland5');
...
insert into customer values(null, '猪口　一休','福岡県福岡市博多区東公園7-7','inokuchi','BearMouse9');
